...
class HttpServer {
    ...
    static withSecureServerAndBasicAuthentication(base, port=8443, cl) throws Exception {
        ...
        String jettyDistKeystore = ResourcePath.resourcePath("keystore", "ssl") as String
        ...
        LoginService loginService = new HashLoginService("MyRealm", ResourcePath.resourcePath("realm.properties", "ssl") as String)
